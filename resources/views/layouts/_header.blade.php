<nav class="navbar navbar-expand-lg bg-dark navbar-dark bd-navbar  fixed-top nav-border">
    <div class="container">
        <a href="{{ route('index') }}" class="navbar-brand text-golden"><span class="text-golden">我在Weibo-App学习</span></a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navmenu">
            <span class="navbar-toggler-icon"></span>
        </button>
  
        <div class="collapse navbar-collapse box-s" id="navmenu" >
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto ">
              ...
              <li class="nav-item col-6 col-md-auto dropdown user-name">
                  <!-- <div class=" d-flex flex-row   "> -->
                      <a class=" nav-link p-2 d-flex flex-row dropdown-toggle"  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="navbarDropdown" href="#"  rel="noopener">
            ...
            @else
            <a class="btn btn-bd-download d-lg-inline-block my-2 my-md-0 ms-md-2 {{Request::getPathinfo() == '/login' ? 'active' :''}}" href="{{ route('login') }}">登录</a>
            <a class="btn btn-bd-download d-lg-inline-block my-2 my-md-0 ms-md-2  {{Request::getPathinfo() == '/signup' ? 'active' :''}}" href="{{ route('user.signup') }}"   >注册</a>
            @endif
          </div>
    </div>
</nav>